...
from .views import MenuPrincipal02, Galeria02, QuienesSomos02, APIferiados, RegistroContacto, RegistroUsuario, home, InicioSesion, ver, form_mod_registro, form_registro, form_del_registro 
